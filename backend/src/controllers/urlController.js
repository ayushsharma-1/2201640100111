...
async function createShortUrl(req, res) {
    try {
        ...
        // console.log('DEBUG: createShortUrl parameters:', { url: url?.substring(0, 50), validity, customShortcode: shortcode, bodySize: JSON.stringify(req.body).length }); // Testing parameter validation
